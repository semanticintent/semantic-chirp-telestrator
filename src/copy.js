...
export const copy = {
  ...
  signal: {
    ...
    pen: {
      ...
      pill: 'WebMCP',
      on: '{n} tools registered with navigator.modelContext',
      off: 'Not available in this browser. Chrome 146+ with the enable-webmcp-testing flag, or the Codex desktop browser, registers them.',
      pillOn: '{n} tools',
      pillOff: 'off',
    },
    analyst: {
