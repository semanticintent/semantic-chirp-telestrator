...
| Wipe | `wipe` | — | — | chrome, chrome-panel, chrome-hand, chrome-replay, rink, spot, strips, replay, panel, hand | `wipe` | Clean the screen. The roster stays cued; the read, the circle, and the replay are cleared. |
